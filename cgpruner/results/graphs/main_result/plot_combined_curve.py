...
our_wala = ax.plot(wala_prec,wala_rec,color='black', linestyle='-', label='cg-pruner on Wala')
wala_baseline = ax.scatter([0.2384],[0.9534],color='black', marker = 'x', label='Baseline Wala 0CFA')

our_doop = ax.plot(doop_prec,doop_rec,color='green', linestyle='--', label='cg-pruner on Doop')
doop_baseline = ax.scatter([0.2308],[0.9206],color='green', marker = '^', label='Baseline Doop 0CFA')

our_peta = ax.plot(peta_prec,peta_rec,color='blue', linestyle=':', label='cg-pruner on Petablox')
peta_baseline = ax.scatter([0.2976],[0.8875],color='blue', marker = 'o', label='Baseline Petablox 0CFA')
...
wala_intro_point = ax.scatter([0.50],[0.92],color='black', marker = '*')
doop_intro_point = ax.scatter([0.50],[0.88],color='green', marker = '*')
peta_intro_point = ax.scatter([0.50],[0.87],color='blue', marker = '*')
