...
static_cgs_dir = '/20TB/mohammad/xcorpus-total-recall/static_cgs/opal/final'
json_file = "/home/mohammad/projects/TracePruner/scripts/static_cg_generation/opal/configs/opal_config.json"
...
# === Config CSVs ===
config_files = [
    "opal_default_1change_configs_v1.csv",
]
config_file_versions = ["v1",]  # Must match order

config_dir = "/home/mohammad/projects/TracePruner/scripts/static_cg_generation/opal/configs"
...
def find_diff(version1, id1, version2, id2):
    ...
    for program in os.listdir(static_cgs_dir):
        file1 = os.path.join(static_cgs_dir, program, f"opal_{version1}_{id1}.csv")
        file2 = os.path.join(static_cgs_dir, program, f"opal_{version2}_{id2}.csv")
        ...
        if not df_only_in_df1.empty:
            ...
            diff_dir = os.path.join(output_dir, 'opal', 'final', program)
