...
tool_name = "doop"
scgs_dir = f"/20TB/mohammad/xcorpus-total-recall/static_cgs/{tool_name}/{config_file_version}/out"
...
def get_all_edges(program_name, config_id):
    ...
    scg_path = os.path.join(scgs_dir, f'{program_name}_{config_id}.csv')
